<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); ?>
	...
	<div class="oliv_content">
		<h2>Anmelden</h2>
		<p>Melden Sie sich hier an, um Zugriff auf die Verwaltungsoberfl√§che zu erhalten.</p>
	</div>
...
// [Mandatory]
//var wayf_sp_entityID = "https://dlf.uzh.ch/shibboleth";
var wayf_sp_entityID = "https://www.uzh.ch/shibboleth"

// Shibboleth Service Provider handler URL
// Examples: "https://point.switch.ch/Shibboleth.sso", "https://rr.aai.switch.ch/aaitest/Shibboleth.sso"
// [Mandatory, if wayf_use_discovery_service = false]
//var wayf_sp_handlerURL = "https://dlf.uzh.ch/Shibboleth.sso";
var wayf_sp_handlerURL = "https://www.uzh.ch/Shibboleth.sso";

// URL on this resource that the user should be returned to after authentication
// Examples: "https://econf.switch.ch/aai/home", "https://olat.uzh.ch/my/courses"
// [Mandatory]
var wayf_return_url = "<?php echo $return_url ?>"; 
...
//        data:"univ.org universitÈ intÈrnationale X"},
//
//        {name:"Some Other University",
//        entityID:"https://other.univ.edu/idp/shibboleth",
//        SAML1SSOurl:"https://other.univ.edu/shibboleth-idp/SSO",
//        logoURL:"https://other.univ.edu/favicon.ico",
//        data:"other.univ.org autre universitÈ intÈrnationale X"},
// ];
...
<noscript>
  ...
  <p>
    <!--<strong>Login:</strong> Javascript is not enabled for your web browser. Please use the <a href="/Shibboleth.sso/DS?target=https%3A%2F%2Fdlf.uzh.ch%2F">non-Javascript Login</a>. -->
